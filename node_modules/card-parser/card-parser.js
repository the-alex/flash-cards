...
// A card is a pairing between a word and a definition, linked to
// collections of cards called decks. A card can belong to multiple
// decks.
var create_card = function (word, definition, deck_name) {
  return {
    'word': word,
...
var create_deck = function (path, deck_name) {
  ...
  word_def_pairs.forEach(function(pair) {
    deck.push(create_card(pair[0], pair[1], deck_name));
  });
